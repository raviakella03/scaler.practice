...
* He got very excited and wanted to obtain the longest subsequence of vowels from the original string. You are asked to
* help Raman.
...
* 2. A subsequence is a sequence that can be derived from another sequence by deleting some or no elements from the
* original sequence without changing the order of the remaining elements.
...
* Input 2: abhishek
* Output 2: aie
* Input 3: interviewbit
* Output 3: ieiei
* */

public interface VowelIt {
